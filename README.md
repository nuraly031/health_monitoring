<h1>Health Monitoring Zein</h1><h2 align="center"> Платформа для мониторинга здоровья и эмоционального состояния пациента с использованием искусственного интеллекта и игровых элементов</h2>
